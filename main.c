...
int main(int argc, char * argv[]){ //main function including command line arguments
    ...
    */
    ...
    if (invalidate == false){ 
        printf("-g [-o outputfilename]\n-t|-p [-i fileIfilename] [-o outputfilename]\n-c|-ct|-cp [-t|-p] [-i fileIfilename] [-o outputfilename]\n");
        return 0;
    }
    ...
    free(seqB);
        ...
        }else{ //if no fileI file was specified
        ...
        // once all the given fileIs are assorted with and it is assigned to individual cases
